      ...
      if (event.key === "Enter") {
        ...
        if (CommandArea) {
          ...
          if (CommandArea.value === "github") {
            ...
            window.open("https://github.com/RadioactivePotato/krunch-site", '_blank');
        ...
        <ul className='previousCommands' id='console23'>
          {prevusedCommand.map((item, index) => {
            if (item.match(new RegExp(`\\b${"github"}\\b`, 'g'))) {
              ...
              return <li key={index}>{item}<br></br><br></br><span style={{ color: "#c9c9c9" }}>Opened the source code of this site in a new tab: https://github.com/RadioactivePotato/krunch-site</span><br></br><br></br></li>;
            }
